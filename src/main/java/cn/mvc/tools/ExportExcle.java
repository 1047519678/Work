...
public class ExportExcle {
     ...
     *        sheet名称和表头值
     */
    public static void excelExport(List<?> dataList, Map<String, String> titleMap, String sheetName, String _filedisplay) {
        // 初始化workbook
        ...
        try {
            ...
            String filedisplay = _filedisplay;
...
//                    String value = "";
//                    if(m.invoke(obj, WeiXiuData) != (Object) null){
//                        value = m.invoke(obj, WeiXiuData).toString();
//                    }
